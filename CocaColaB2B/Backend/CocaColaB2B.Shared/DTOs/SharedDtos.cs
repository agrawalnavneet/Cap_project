...
public class UpdateUserRequest { public string FullName { get; set; } = ""; public string Email { get; set; } = ""; public string Role { get; set; } = ""; public string? ContactNumber { get; set; } public string? Address { get; set; } }
...
// ──── Order DTOs ────
public class OrderDto { public Guid Id { get; set; } public Guid WholesalerId { get; set; } public string WholesalerName { get; set; } = ""; public Guid? DriverId { get; set; } public string? DriverName { get; set; } public DateTime OrderDate { get; set; } public decimal TotalAmount { get; set; } public string Status { get; set; } = ""; public string ShippingAddress { get; set; } = ""; public List<OrderItemDto> Items { get; set; } = new(); }
