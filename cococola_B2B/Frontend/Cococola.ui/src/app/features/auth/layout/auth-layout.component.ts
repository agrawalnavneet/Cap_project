...
@Component({
        ...
        <div class="auth-layout__brand-content">
          ...
          <div class="auth-layout__logo">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="48" height="48" rx="12" fill="#F40009"/>
              <text x="24" y="33" text-anchor="middle" fill="white" font-size="26" font-weight="800" font-family="Georgia, serif">C</text>
            </svg>
            <span class="auth-layout__logo-text">
              <span style="color: white;">Coca-Cola</span><span style="color: #D4A017;"> B2B</span>
            </span>
          </div>

          <!-- Headline -->
          <h1 class="auth-layout__headline">Refresh your business.<br>One order at a time.</h1>
          <p class="auth-layout__subtext">India's trusted B2B wholesale beverage distribution platform</p>
  ...
  styles: [`
    ...
    .auth-layout__brand {
      width: 45%;
      background: linear-gradient(135deg, #8B0000 0%, #CC0007 50%, #F40009 100%);
      display: flex;
