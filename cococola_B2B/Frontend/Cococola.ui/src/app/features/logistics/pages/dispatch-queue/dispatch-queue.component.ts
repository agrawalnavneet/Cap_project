...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Dispatch Queue" subtitle="Assign agents to orders ready for dispatch">
        <div page-actions>
      ...
      <ccb2b-modal [isOpen]="showAssignModal" title="Assign Delivery Agent" size="lg" (closed)="closeModal()">
        <div class="modal-content" *ngIf="selectedOrder">
          ...
          <div *ngIf="!agentsLoading && regionAgents.length > 0" class="agents-list">
            <div *ngFor="let agent of regionAgents" class="agent-card"
              ...
              <ccb2b-avatar [name]="agent.fullName" size="sm"></ccb2b-avatar>
