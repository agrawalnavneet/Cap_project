...
import { TimelineEvent } from '../../../../shared/ui/timeline/ccb2b-timeline.component';
      ...
      <div *ngIf="!loading && order" class="order-detail-grid">
        ...
        <div class="detail-card">
          ...
          <div class="info-row">
            ...
            <ccb2b-status-badge [status]="order.status"></ccb2b-status-badge>
          </div>
          <div class="info-row">
        ...
        <div class="detail-card detail-card--full">
          ...
          <div style="padding: 20px;">
            <ccb2b-timeline [events]="timelineEvents"></ccb2b-timeline>
          </div>
        </div>
