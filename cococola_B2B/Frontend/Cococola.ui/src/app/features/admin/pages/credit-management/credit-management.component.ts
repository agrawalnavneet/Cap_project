...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Credit Management" subtitle="Manage dealer credit limits and utilization"></ccb2b-page-header>
      <div class="kpi-grid">
        <ccb2b-stat-card title="Total Credit Extended" [value]="'₹' + formatNum(totalCredit)" icon="credit-card" iconColor="blue" [loading]="loading"></ccb2b-stat-card>
        <ccb2b-stat-card title="Total Outstanding" [value]="'₹' + formatNum(totalOutstanding)" icon="trending-up" iconColor="amber" [loading]="loading"></ccb2b-stat-card>
        <ccb2b-stat-card title="Over 80% Utilization" [value]="highUtil" icon="alert-triangle" iconColor="red" [loading]="loading"></ccb2b-stat-card>
      </div>
      ...
      <ccb2b-modal *ngIf="showCreditModal" [open]="showCreditModal" title="Adjust Credit Limit" size="sm" (close)="closeModal()">
