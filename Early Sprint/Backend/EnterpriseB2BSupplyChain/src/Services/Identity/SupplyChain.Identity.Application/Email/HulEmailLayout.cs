...
/// <summary>
/// Industry-standard HTML email layout for the Coca-Cola B2B Supply Platform.
///
...
{
    // ─── Coca-Cola B2B Brand Palette ─────────────────────────────────────
    public const string Primary       = "#F40009";
    public const string PrimaryDark   = "#CC0007";
    public const string Accent        = "#D4A017";
    ...
    /// <summary>
    /// Wraps body HTML in the standard Coca-Cola B2B email skeleton (header + footer + outer table).
    /// </summary>
    ...
    /// <param name="accentColor">Header bar color. Defaults to Coca-Cola primary red.</param>
                      ...
                      <tr>
                        <td style="padding:24px 36px 32px 36px;text-align:center;">
                          <div style="font-size:13px;color:{{TextMuted}};line-height:1.6;">
                            This is an automated message from the <strong style="color:{{TextSecondary}};">Coca-Cola B2B Supply Platform</strong>.<br/>
                            Please do not reply directly to this email.
                          </div>
                          <div style="font-size:12px;color:{{TextMuted}};margin-top:14px;">
                            Need help? Contact <a href="mailto:navfizzenterprisese@gmail.com" style="color:{{Primary}};text-decoration:none;font-weight:600;">navfizzenterprisese@gmail.com</a>
                          </div>
                          <div style="font-size:11px;color:{{TextMuted}};margin-top:18px;letter-spacing:0.3px;">
                            &copy; 2026 Coca-Cola B2B Enterprise &middot; All rights reserved
                          </div>
                        </td>
                      </tr>
    ...
    /// <summary>Closing block: "Regards, Coca-Cola B2B Team".</summary>
    public static string Signoff()
        => $"""
            <div style="margin-top:28px;font-size:14px;color:{TextSecondary};">
              Regards,<br/>
              <strong style="color:{TextPrimary};">Coca-Cola B2B Team</strong>
            </div>
            """;
