...
import { CcbConfirmService, ConfirmConfig } from './ccb2b-confirm.service';
import { Subscription } from 'rxjs';

@Component({
  selector: 'ccb2b-confirm-dialog',
  standalone: false,
  template: `
...
export class CcbConfirmDialogComponent implements OnInit, OnDestroy {
  visible = false;
  config: ConfirmConfig = { title: '', message: '', variant: 'info' };
  private sub!: Subscription;

  constructor(private confirmService: CcbConfirmService) {}
