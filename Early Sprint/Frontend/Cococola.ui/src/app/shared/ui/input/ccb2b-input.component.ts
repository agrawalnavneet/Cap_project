...
@Component({
  selector: 'ccb2b-input',
  standalone: false,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CcbInputComponent),
      multi: true
    }
  ],
  template: `
    <div class="ccb2b-input" [class.ccb2b-input--focused]="focused" [class.ccb2b-input--filled]="!!value"
         [class.ccb2b-input--error]="error" [class.ccb2b-input--disabled]="disabled">
      <label *ngIf="label" class="ccb2b-input__label" [class.ccb2b-input__label--float]="focused || !!value">
        {{ label }}<span *ngIf="required" class="ccb2b-input__required">*</span>
      </label>
      <div class="ccb2b-input__wrapper">
        <span *ngIf="prefixIcon" class="ccb2b-input__prefix" [innerHTML]="getIconSvg(prefixIcon)"></span>
        <input
          #inputEl
          [type]="currentType"
          ...
          (focus)="onFocus()"
          (blur)="onBlur()"
          class="ccb2b-input__field"
          autocomplete="off" />
        <button *ngIf="type === 'password'" type="button" class="ccb2b-input__toggle"
        ...
        <span *ngIf="suffixIcon && type !== 'password'" class="ccb2b-input__suffix" [innerHTML]="getIconSvg(suffixIcon)"></span>
      </div>
      <span *ngIf="error" class="ccb2b-input__error">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
        {{ error }}
      </span>
      <span *ngIf="hint && !error" class="ccb2b-input__hint">{{ hint }}</span>
    </div>
  `,
  styles: [`
    .ccb2b-input {
    ...
    .ccb2b-input__required {
      color: var(--hul-danger);
      margin-left: 2px;
    }

    .ccb2b-input__wrapper {
      display: flex;
      align-items: center;
    ...
    .ccb2b-input--focused .ccb2b-input__wrapper {
      border-color: var(--border-focus);
      box-shadow: 0 0 0 3px rgba(3, 105, 161, 0.1);
    }

    .ccb2b-input--error .ccb2b-input__wrapper {
      border-color: var(--hul-danger) !important;
      box-shadow: 0 0 0 3px rgba(239, 68, 68, 0.1) !important;
    }

    .ccb2b-input--disabled .ccb2b-input__wrapper {
    ...
    .ccb2b-input__field::placeholder {
    ...
    .ccb2b-input--focused .ccb2b-input__prefix,
    .ccb2b-input--focused .ccb2b-input__suffix {
...
export class CcbInputComponent implements ControlValueAccessor {
  @Input() label = '';
  @Input() placeholder = '';
