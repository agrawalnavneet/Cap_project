...
@Component({
  ...
  template: `
    <div class="sa-shell">
      <ccb2b-sidebar [items]="sidebarItems" [brandLabel]="'Super Admin'" [sidebarClass]="'sidebar--super-admin'"
                   [collapsed]="collapsed" (collapsedChange)="collapsed = $event"></ccb2b-sidebar>
        ...
        <header class="topbar">
          <div class="topbar__left">
            ...
            <select [(ngModel)]="activePortal" (change)="onPortalChange()" class="portal-select">
              ...
              <option value="admin">Coca-Cola India (Admin)</option>
            </select>
          ...
          <div class="topbar__right">
            ...
            <ccb2b-avatar [name]="userName" size="sm"></ccb2b-avatar>
