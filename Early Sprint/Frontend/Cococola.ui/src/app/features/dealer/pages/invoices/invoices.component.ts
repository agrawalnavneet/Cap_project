...
@Component({
  ...
  template: `
    <div class="invoices-page">
      <ccb2b-page-header title="Invoices" subtitle="View and download your GST invoices"
        [breadcrumbs]="[{label: 'Home', route: '/dealer/dashboard'}, {label: 'Invoices'}]">
      </ccb2b-page-header>

      <ccb2b-skeleton *ngIf="loading" type="table" [count]="5"></ccb2b-skeleton>
        ...
        <table>
          ...
          <tbody>
            <tr *ngFor="let inv of invoices" class="invoice-row">
              ...
              <td><ccb2b-badge [variant]="inv.gstType === 'IGST' ? 'info' : 'primary'" size="sm">{{ inv.gstType }}</ccb2b-badge></td>
      ...
      <ccb2b-empty-state *ngIf="!loading && invoices.length === 0"
