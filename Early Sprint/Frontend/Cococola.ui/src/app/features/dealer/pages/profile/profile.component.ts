...
@Component({
  ...
  template: `
    <div class="profile-page">
      <ccb2b-page-header title="Profile" subtitle="Manage your account details and preferences"
        [breadcrumbs]="[{label: 'Home', route: '/dealer/dashboard'}, {label: 'Profile'}]">
      </ccb2b-page-header>

      <div class="profile-layout">
        <!-- Profile Card -->
        <ccb2b-card padding="lg" shadow="sm">
          <div class="profile-header">
            <ccb2b-avatar [name]="user?.fullName || 'Dealer'" size="xl" [imageUrl]="user?.profilePictureUrl" [editable]="true" (fileSelected)="onProfilePictureSelected($event)"></ccb2b-avatar>
            <div class="profile-info">
              <h3>{{ user?.fullName || 'Dealer' }}</h3>
              <p>{{ user?.email }}</p>
              <ccb2b-badge variant="primary" size="sm">{{ user?.role || 'Dealer' }}</ccb2b-badge>
            </div>
          </div>
        </ccb2b-card>
        ...
        <ccb2b-card padding="lg" shadow="sm">
          <div class="address-header">
            ...
            <ccb2b-button variant="outline" size="sm" (click)="openAddAddressModal()">+ Add New</ccb2b-button>
          </div>
        ...
        <ccb2b-card padding="lg" shadow="sm">
          ...
          <div class="account-actions">
            <ccb2b-button variant="outline" size="md" (click)="openChangePasswordModal()">Change Password</ccb2b-button>
            <ccb2b-button variant="danger" size="md" (click)="logout()">Sign Out</ccb2b-button>
          </div>
        </ccb2b-card>
      </div>

      <!-- Edit Address Modal -->
      <ccb2b-modal *ngIf="showEditAddressModal" [open]="showEditAddressModal" title="Edit Shipping Address" size="md" (close)="showEditAddressModal = false">
      ...
      <!-- Add Address Modal -->
      <ccb2b-modal *ngIf="showAddAddressModal" [open]="showAddAddressModal" title="Add Shipping Address" size="md" (close)="showAddAddressModal = false">
        <div class="address-form">
          <div class="form-row">
            <div class="form-group">
              <label>Address Label *</label>
      ...
      <ccb2b-modal *ngIf="showChangePasswordModal" [open]="showChangePasswordModal" title="Change Password" size="sm" (close)="showChangePasswordModal = false">
