...
<div class="returns-page">
  <ccb2b-page-header title="My Returns" subtitle="Track and manage your return requests"
    [breadcrumbs]="[{label: 'Home', route: '/dealer/dashboard'}, {label: 'Returns'}]">
  </ccb2b-page-header>

  <!-- Eligible Orders for Return -->
  <ccb2b-card *ngIf="myOrders.length > 0" style="margin-bottom: 20px;">
  ...
  <ccb2b-card>
    <div style="padding: 20px;">
      ...
      <ccb2b-skeleton *ngIf="loading" type="text" [count]="3"></ccb2b-skeleton>
      ...
      <div class="returns-list" *ngIf="!loading && returns.length > 0">
        <div *ngFor="let ret of returns" class="return-item">
          <div class="return-item__header">
            ...
            <ccb2b-status-badge [status]="ret.status"></ccb2b-status-badge>
          </div>
  ...
  <!-- Raise Return Modal -->
  <ccb2b-modal *ngIf="showRaiseReturnModal" [open]="showRaiseReturnModal" title="Request Return" size="md" (close)="showRaiseReturnModal = false">
