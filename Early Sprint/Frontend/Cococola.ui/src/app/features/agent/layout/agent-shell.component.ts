      ...
      <aside class="agent-sidebar">
        ...
        <div class="sidebar-brand">
          <div class="sidebar-brand__logo">
            <!-- HUL logo: matches admin/dealer portal ccb2b-sidebar logo -->
          ...
          <div class="sidebar-brand__text" *ngIf="!sidebarCollapsed">
            <span class="brand-name"><span class="brand-hul">Coca-Cola</span><span class="brand-supply"> B2B</span></span>
      ...
      <div class="agent-main-wrap">
        ...
        <header class="agent-topbar">
          ...
          <div class="topbar-brand">
            ...
            <span class="topbar-brand__name"><span class="topbar-hul">Coca-Cola</span><span class="topbar-supply"> B2B</span></span>
          </div>
          ...
          <div class="mobile-sidebar__header">
            <div class="mobile-brand">
              ...
              <span style="font-family:var(--font-display);font-weight:700;font-size:16px;color:var(--text-primary)">
                <span style="color:#F40009">Coca-Cola</span><span style="color:var(--text-primary)"> B2B</span>
              </span>
            </div>
