...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Email Templates" subtitle="Manage notification templates for all system events"></ccb2b-page-header>
      ...
      <ccb2b-data-table [columns]="columns" [data]="templates" [loading]="loading" [totalCount]="templates.length"
      ...
      <ccb2b-modal *ngIf="showModal" [open]="showModal" [title]="'Edit Template — ' + editTemplate?.eventType" size="xl" (close)="showModal = false">
