...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Products" subtitle="Manage product catalog">
      ...
      <ccb2b-data-table [columns]="columns" [data]="products" [loading]="loading" [totalCount]="products.length"
      ...
      <ccb2b-modal *ngIf="showModal" [open]="showModal" [title]="isEditing ? 'Edit Product' : 'Add Product'" size="lg" (close)="showModal = false">
        <div class="product-form">
          <div class="form-grid">
            <div class="form-group"><label>SKU <span class="req">*</span></label><input type="text" [(ngModel)]="form.sku" [disabled]="isEditing" class="form-input" style="text-transform:uppercase" placeholder="e.g. CCB-BEV-001" /></div>
...
export class AdminProductsComponent implements OnInit {
  ...
  constructor(private http: ZoneHttpService, private toast: ToastService, private confirm: CcbConfirmService) {
