...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Dealer Approvals" subtitle="Review and approve new dealer registrations"></ccb2b-page-header>

      <ccb2b-tabs [tabs]="tabs" [activeTab]="activeTab" (tabChange)="onTabChange($event)"></ccb2b-tabs>
      ...
      <ccb2b-modal *ngIf="showRejectModal" [open]="showRejectModal" title="Reject Dealer" size="sm" (close)="showRejectModal = false">
...
export class DealerApprovalsComponent implements OnInit {
  ...
  constructor(private http: ZoneHttpService, private confirm: CcbConfirmService, private toast: ToastService) { }
