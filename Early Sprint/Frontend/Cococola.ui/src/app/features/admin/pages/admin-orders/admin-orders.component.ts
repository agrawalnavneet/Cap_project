...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="All Orders" subtitle="Manage and track all orders across dealers">
      ...
      <ccb2b-tabs [tabs]="tabsWithCounts" [activeTab]="activeTab" (tabChange)="onTabChange($event)"></ccb2b-tabs>
      <div style="margin-top:20px">
        <ccb2b-data-table [columns]="columns" [data]="filtered" [loading]="loading" [totalCount]="filtered.length"
