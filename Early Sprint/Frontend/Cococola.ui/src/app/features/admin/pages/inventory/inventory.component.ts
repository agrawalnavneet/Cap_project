...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Inventory" subtitle="Monitor stock levels across all products">
      </ccb2b-page-header>
      ...
      <!-- Restock Modal -->
      <ccb2b-modal *ngIf="showRestock" [open]="showRestock" title="Restock Product" size="sm" (close)="showRestock = false">
      ...
      <!-- Edit Stock Modal -->
      <ccb2b-modal *ngIf="showEditStock" [open]="showEditStock" title="Edit Stock Level" size="sm" (close)="showEditStock = false">
        <div class="inventory-modal">
