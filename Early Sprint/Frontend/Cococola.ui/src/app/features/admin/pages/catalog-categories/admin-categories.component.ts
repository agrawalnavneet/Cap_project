...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Categories" subtitle="Organize product catalog by category and brand">
      ...
      <ccb2b-modal *ngIf="showFormModal" [open]="showFormModal"
      ...
      <ccb2b-modal *ngIf="showViewModal" [open]="showViewModal"
...
export class AdminCategoriesComponent implements OnInit {
  ...
  constructor(
    ...
    private confirm: CcbConfirmService
  ) {}
