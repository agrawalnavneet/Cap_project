...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Manage Returns" subtitle="Review and manage dealer return requests"></ccb2b-page-header>
      
      <div style="margin-top:20px">
        <ccb2b-data-table [columns]="columns" [data]="returns" [loading]="loading" [totalCount]="returns.length"
      ...
      <ccb2b-modal *ngIf="showApproveModal" [open]="showApproveModal" title="Approve Return Request" size="sm" (close)="showApproveModal = false">
      ...
      <!-- Reject Return Modal -->
      <ccb2b-modal *ngIf="showRejectModal" [open]="showRejectModal" title="Reject Return Request" size="sm" (close)="showRejectModal = false">
        <div class="modal-form" *ngIf="selectedReturn">
      ...
      <ccb2b-modal *ngIf="showViewModal" [open]="showViewModal" [title]="'Return Details'" size="md" (close)="showViewModal = false">
        <div class="return-detail" *ngIf="selectedReturn">
          <div class="detail-section">
            ...
            <div class="detail-row">
              <label>Status</label>
              <ccb2b-status-badge [status]="selectedReturn.status"></ccb2b-status-badge>
            </div>
            <div class="detail-row">
