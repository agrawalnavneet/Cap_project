...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Admin Dashboard" subtitle="Overview of your supply chain operations"></ccb2b-page-header>

      <!-- KPI Row 1 -->
      <div class="kpi-grid">
        <ccb2b-stat-card title="Pending Dealers" [value]="stats.pendingDealers" subtitle="+{{stats.pendingDealersWeek}} this week" icon="user-clock" iconColor="amber" trend="up" [loading]="loading"></ccb2b-stat-card>
        <ccb2b-stat-card title="Active Dealers" [value]="stats.activeDealers" icon="users" iconColor="blue" [loading]="loading"></ccb2b-stat-card>
        <ccb2b-stat-card title="Orders Today" [value]="stats.ordersToday" icon="shopping-cart" iconColor="green" trend="up" [loading]="loading"></ccb2b-stat-card>
        <ccb2b-stat-card title="Revenue This Month" [value]="'₹' + formatNum(stats.revenueMonth)" icon="trending-up" iconColor="purple" [loading]="loading"></ccb2b-stat-card>
      </div>

      <!-- KPI Row 2 -->
      <div class="kpi-grid" style="margin-top:14px">
        <ccb2b-stat-card title="In Transit" [value]="stats.inTransit" icon="truck" iconColor="blue" [loading]="loading"></ccb2b-stat-card>
        <ccb2b-stat-card title="On Hold" [value]="stats.onHold" icon="pause-circle" iconColor="amber" [loading]="loading"></ccb2b-stat-card>
        <ccb2b-stat-card title="Low Stock Products" [value]="stats.lowStock" icon="alert-triangle" iconColor="red" [loading]="loading"></ccb2b-stat-card>
        <ccb2b-stat-card title="Invoices Generated" [value]="stats.invoicesMonth" icon="receipt" iconColor="teal" [loading]="loading"></ccb2b-stat-card>
      </div>
      ...
      <div class="dashboard-row">
        ...
        <div class="dashboard-card dashboard-card--approvals">
          ...
          <div *ngFor="let dealer of pendingDealers.slice(0, 5)" class="approval-row" routerLink="/admin/dealers/pending">
            <ccb2b-avatar [name]="dealer.fullName" size="sm"></ccb2b-avatar>
            ...
            <table class="mini-table">
              ...
              <tbody>
                <tr *ngFor="let order of recentOrders.slice(0, 8)">
                  ...
                  <td><ccb2b-status-badge [status]="order.status"></ccb2b-status-badge></td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  styles: [`
    ...
    .kpi-grid ccb2b-stat-card, .kpi-grid .stat-card-wrapper { height: 100%; display: flex; flex-direction: column; }
