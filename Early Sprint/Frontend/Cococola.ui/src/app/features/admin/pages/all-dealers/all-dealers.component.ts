...
import { DataTableColumn, DataTableAction } from '../../../../shared/ui/data-table/ccb2b-data-table.component';
...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="All Dealers" subtitle="Manage all registered dealers">
      ...
      <ccb2b-data-table [columns]="columns" [data]="dealers" [loading]="loading" [totalCount]="dealers.length"
      ...
      <!-- View Dealer Modal -->
      <ccb2b-modal *ngIf="showViewModal" [open]="showViewModal" [title]="viewingDealer?.fullName || 'Dealer Details'" size="xl" (close)="showViewModal = false">
                ...
                <table *ngIf="dealerInvoices.length > 0" class="data-table">
                  ...
                  <tbody>
                    <tr *ngFor="let invoice of dealerInvoices">
                      ...
                      <td><ccb2b-status-badge [status]="invoice.status"></ccb2b-status-badge></td>
      ...
      <ccb2b-modal *ngIf="showDeleteModal" [open]="showDeleteModal" title="Delete Dealer" size="sm" (close)="showDeleteModal = false">
      ...
      <ccb2b-modal *ngIf="showSuspendModal" [open]="showSuspendModal" title="Suspend Dealer" size="sm" (close)="showSuspendModal = false">
      ...
      <ccb2b-modal *ngIf="showCreditModal" [open]="showCreditModal" title="Update Credit Limit" size="sm" (close)="showCreditModal = false">
