...
@Component({
  ...
  template: `
    <div class="admin-shell">
      <ccb2b-sidebar [items]="sidebarItems" [brandLabel]="'Admin Panel'" [sidebarClass]="'sidebar--admin'"
                   [collapsed]="sidebarCollapsed" (collapsedChange)="sidebarCollapsed = $event"></ccb2b-sidebar>
