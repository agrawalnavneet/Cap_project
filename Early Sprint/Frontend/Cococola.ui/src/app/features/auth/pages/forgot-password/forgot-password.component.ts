    ...
    <div class="forgot-page">
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="auth-form" novalidate>
        <div class="form-group">
          <ccb2b-input label="Email address" type="email" prefixIcon="mail" formControlName="email"
            [required]="true" [error]="getFieldError('email')" placeholder="dealer@company.com"></ccb2b-input>
        </div>
