    ...
    <div class="register-page">
      ...
      <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="auth-form" novalidate>
        <div class="form-group">
          <ccb2b-input label="Full Name" type="text" prefixIcon="user" formControlName="fullName"
            [required]="true" [error]="getFieldError('fullName')" placeholder="Rajesh Kumar"></ccb2b-input>
        </div>

        <div class="form-group">
          <ccb2b-input label="Business Name" type="text" prefixIcon="building-2" formControlName="businessName"
            [required]="true" [error]="getFieldError('businessName')" placeholder="Kumar Wholesale Pvt Ltd"></ccb2b-input>
        </div>

        <div class="form-group">
          <ccb2b-input label="Email" type="email" prefixIcon="mail" formControlName="email"
            [required]="true" [error]="getFieldError('email')" placeholder="rajesh@company.com"></ccb2b-input>
        </div>

        <div class="form-group">
          <ccb2b-input label="Phone Number" type="tel" prefixIcon="phone" formControlName="phoneNumber"
            [required]="true" [error]="getFieldError('phoneNumber')" placeholder="9876543210"></ccb2b-input>
        </div>

        <div class="form-group">
          <ccb2b-input label="Password" type="password" prefixIcon="lock" formControlName="password"
            [required]="true" [error]="getFieldError('password')" placeholder="Min. 8 characters"></ccb2b-input>
          <app-password-strength [password]="registerForm.get('password')?.value || ''"></app-password-strength>
        </div>

        <div class="form-group">
          <ccb2b-input label="GST Number" type="text" prefixIcon="file-text" formControlName="gstNumber"
            [required]="true" [error]="getFieldError('gstNumber')" placeholder="29AABCK1234F1Z5"
            hint="15-character GST Identification Number"></ccb2b-input>
        </div>

        <div class="form-group">
          <ccb2b-input label="Address Line 1" type="text" prefixIcon="map-pin" formControlName="addressLine1"
            [required]="true" [error]="getFieldError('addressLine1')" placeholder="123 MG Road, Block A"></ccb2b-input>
        </div>

        <div class="form-row">
          <div class="form-group form-group--half">
            <ccb2b-input label="City" type="text" formControlName="city"
              [required]="true" [error]="getFieldError('city')" placeholder="Mumbai"></ccb2b-input>
          </div>
          <div class="form-group form-group--half">
        ...
        <div class="form-group">
          <ccb2b-input label="PIN Code" type="text" formControlName="pinCode"
            [required]="true" [error]="getFieldError('pinCode')" placeholder="400001" [maxlength]="6"></ccb2b-input>
        </div>
        ...
        <ccb2b-button type="submit" variant="primary" size="lg" [fullWidth]="true"
