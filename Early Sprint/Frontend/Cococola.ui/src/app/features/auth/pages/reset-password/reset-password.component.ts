    ...
    <div class="reset-page">
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="auth-form" novalidate>
        ...
        <div class="form-group">
          <ccb2b-input label="New Password" type="password" prefixIcon="lock" formControlName="newPassword"
            [required]="true" [error]="getFieldError('newPassword')" placeholder="Min. 8 characters"></ccb2b-input>
          <app-password-strength [password]="form.get('newPassword')?.value || ''"></app-password-strength>
        </div>

        <div class="form-group">
          <ccb2b-input label="Confirm Password" type="password" prefixIcon="lock" formControlName="confirmPassword"
            [required]="true" [error]="getFieldError('confirmPassword')" placeholder="Confirm your password"></ccb2b-input>
        </div>
