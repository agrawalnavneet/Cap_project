...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header [title]="'Pending Shipments (' + unassigned.length + ')'" subtitle="Assign agents and dispatch orders"></ccb2b-page-header>
      ...
      <div class="cards-list" *ngIf="!loading">
        ...
        <div *ngFor="let s of filtered" class="shipment-card">
          ...
          <div *ngIf="s.agentName" class="assigned-info">
            <ccb2b-avatar [name]="s.agentName" size="sm"></ccb2b-avatar>
