...
import { DataTableColumn } from '../../../../shared/ui/data-table/ccb2b-data-table.component';

@Component({
  selector: 'app-sla-monitor', standalone: false,
  template: `
    <div class="page-container">
      <ccb2b-page-header title="SLA Monitor" subtitle="Track delivery SLA compliance"></ccb2b-page-header>
      <div *ngIf="atRiskCount > 0" class="sla-alert">
        <span>🚨 {{ atRiskCount }} deliveries are at risk of SLA breach</span>
      </div>
      <ccb2b-data-table [columns]="columns" [data]="shipments" [loading]="loading" [totalCount]="shipments.length"
