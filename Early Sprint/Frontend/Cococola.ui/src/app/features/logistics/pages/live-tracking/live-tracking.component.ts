...
@Component({
  ...
  template: `
    <div class="page-container">
      <ccb2b-page-header title="Live Tracking" subtitle="Monitor all active deliveries in real time"></ccb2b-page-header>
    ...
    <ccb2b-modal
      ...
      <div *ngIf="!detailsLoading && selectedOrder" class="tracking-detail">
        ...
        <div class="agent-card" *ngIf="selectedTracking?.agentName">
          <ccb2b-avatar [name]="selectedTracking.agentName" size="md"></ccb2b-avatar>
